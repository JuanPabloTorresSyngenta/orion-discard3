...
jQuery(document).ready(function($) {
    ...
    function populateFieldDropdown(farmId, sectionId) {
        ...
        console.log('Populated fields for farm', farmId, 'section', sectionId, ':', fields.length);
    }
    ...
    function bindEventHandlers() {
        ...
        $('#farm-select').on('change', function() {
            ...
            $('#section-select').val('').prop('disabled', true).find('option:not(:first)').remove();
            $('#field-select').val('').prop('disabled', true).find('option:not(:first)').remove();
    ...
    function submitDiscardForm() {
        ...
        // Validate form
        if (!$('#farm-select').val() || !$('#section-select').val() || !$('#field-select').val() || !scannedCode) {
    ...
    function resetForm() {
        ...
        $('#section-select').prop('disabled', true).find('option:not(:first)').remove();
        $('#field-select').prop('disabled', true).find('option:not(:first)').remove();
        $('#scanner-input').focus();
    }
